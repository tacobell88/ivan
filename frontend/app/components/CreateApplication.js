   ...
   //trying out different ways to save date
    ...
    return (
        <Page title="Application Page">
            <Paper style={{ padding: '20px', marginTop: 40, maxWidth: '800px', marginLeft: 'auto', marginRight: 'auto' }}>
                <form onSubmit={handleSubmit}>
                    <TableContainer container direction="column" alignItems="center" justifyContent="center" style={{marginTop: 40}}>
                        <TableHead>
                            <TableRow>
                                <TableCell>
