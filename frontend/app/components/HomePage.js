...
import { Box, Button, Grid, Modal, Paper, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField } from "@mui/material";
                    ...
                    <TableContainer>
                        ...
                        {appData && appData.map((row) => (
                            <TableRow key={row.app_acronym}>
                                ...
                                <TableCell>
                                    {row.app_permit_create}
                                </TableCell>
                                <TableCell>
                                    {row.app_permit_open}
                                </TableCell>
                                <TableCell>
                                    {row.app_permit_todolist}
                                </TableCell>
                                <TableCell>
                                    {row.app_permit_doing}
                                </TableCell>
                                <TableCell>
                                    {row.app_permit_done}
                                </TableCell>
                                ...
                                <TableCell>
                                    <Button onClick={() => handleKanban(row.app_acronym)}>Kanban</Button>
                                </TableCell>   
                            </TableRow>
                    ))}
                    </TableBody>
